...
# Process new PDF: Extract data with Claude, validate, and create PR
...
# Step 2: Extract data from PDF using Claude
echo "Step 2: Extracting data from PDF with Claude..."
node "$SCRIPT_DIR/extract-pdf-with-claude.js" "$PDF_URL" "$LINK_TEXT" "$TEMP_JSON"
echo ""
...
This PR was automatically generated by the PDF extraction workflow using Claude API.
